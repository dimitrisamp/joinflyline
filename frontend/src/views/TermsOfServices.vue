  ...
  <div class="terms-of-services">
    ...
    <div class="container">
      <div class="terms-of-services__content">
        ...
        <p>
          Welcome to the FlyLine™ Mobile App! This Mobile App Terms of Service
          Agreement (“Agreement”) is a binding agreement between you (“End User”
          or “you”) and Wanderift, Inc., a Delaware corporation, doing business
          as FlyLine (“FlyLine,” “we,” “us,” or “our”). This Agreement governs
          your use of the FlyLine™ mobile application (including all related
          documentation, the “App”) on the iOS or Android platforms. The App is
          licensed, not sold, to you.
        </p>
        <p>
          BY CLICKING THE “AGREE” BUTTON OR USING THE APP, YOU (A) ACKNOWLEDGE
          THAT YOU HAVE READ AND UNDERSTAND THIS AGREEMENT AND THE FLYLINE
          PRIVACY POLICY; (B) REPRESENT THAT YOU ARE OF LEGAL AGE TO ENTER INTO
          A BINDING AGREEMENT; AND (C) ACCEPT THIS AGREEMENT AND AGREE THAT YOU
          ARE LEGALLY BOUND BY ITS TERMS. IF YOU DO NOT AGREE TO THESE TERMS AND
          THE FLYLINE PRIVACY POLICY, DO NOT USE THE APP AND DELETE IT FROM YOUR
          MOBILE DEVICE.
        </p>

        <p>
          1.
          <strong style="font-family: dona-bold;">License Grant.</strong>
          Subject to the terms of this Agreement, FlyLine grants you a limited,
        ...
        <ul>
          <li>
            ...
            App’s documentation; and
          </li>
          <li>
            access, stream, download, and use on such Mobile Device the Content
            and Services (as defined in Section 5) made available in or
            otherwise accessible through the App, strictly in accordance with
            this Agreement and the Terms of Use applicable to such Content and
            Services as set forth in Section 5.
          </li>
        </ul>
        <p style="font-family: dona-bold;">
        ...
        <p>
          3. <strong>Reservation of Rights.</strong> You acknowledge and agree
          that the App is provided under license, and not sold, to you. You do
          not acquire any ownership interest in the App under this Agreement, or
          any other rights thereto other than to use the App in accordance with
          the license granted, and subject to all terms, conditions, and
          restrictions, under this Agreement. FlyLine and its licensors and
        ...
        <p>
          4. <strong>Changes to this Agreement.</strong> We may revise and
          update this Agreement from time to time in our sole discretion. All
          changes are effective immediately when we post them, and apply to all
          access to and use of the App thereafter. However, any changes to the
          dispute resolution provisions set out in Governing Law will not apply
          to any disputes for which the parties have actual notice on or before
          the date the change is posted on the App.
        </p>
        <p>
          Your continued use of the App following the posting of revised
        ...
        <p>
          Moreover, the FlyLine reserves the right to suspend, or discontinue
          the App for any reason, with or without notice.
        </p>
        <p>
          5. <strong>Content and Services.</strong> The App may provide you with
          travel booking services and other related products and services and
          certain features, functionality, and content accessible on or through
          the FlyLine website (the “<strong>Site</strong>”) or the App
          (collectively, “<strong>Content and Services</strong>”).
        </p>
        <p>
          6. <strong>Membership Program.</strong> You acknowledge and agree that
          the FlyLine membership program is subject to the FlyLine Membership
          Terms and Conditions. While you may access the membership program
          through the App, certain activities, including booking travel, will be
          subject to the FlyLine Membership Terms and Conditions.
        </p>
        <p>
          7. <strong>Collection and Use of Your Information.</strong> You
          acknowledge that when you download, install, or use the App, FlyLine
          may use automatic means (including, for example, cookies and web
          beacons) to collect information about your Mobile Device and about
          your use of the App. You also may be required to provide certain
          ...
          subject to our Privacy Policy. By downloading, installing, using, and
          providing information to or through this App, you consent to all
          actions taken by us with respect to your information in compliance
          with the Privacy Policy.
        </p>
        <p>
          8. <strong>Geographic Restrictions.</strong> The Content and Services
          are based in the state of Texas in the United States and provided for
          ...
          If you access the Content and Services from outside the United States,
          you are responsible for compliance with local laws.
        </p>
        <p>
          9. <strong>Updates.</strong> FlyLine may from time to time in its sole
          discretion develop and provide App updates, which may include
          ...
          and functionality. You agree that FlyLine has no obligation to provide
        ...
        <ul>
          <li>
            the App will automatically download and install all available
            Updates; or
          </li>
          <li>
        ...
        <p>
          10. <strong>Third-Party Materials.</strong> The App may display,
          ...
          including through third-party advertising (“Third-Party Materials”).
          You acknowledge and agree that FlyLine is not responsible for
          Third-Party Materials, including their accuracy, completeness,
          timeliness, validity, copyright compliance, legality, decency,
          quality, or any other aspect thereof. FlyLine does not assume and will
        ...
        <p>11. <strong>Term and Termination.</strong></p>
        <ul>
          <li>
            The term of Agreement commences when you acknowledge your acceptance
            and will continue in effect until terminated by you or FlyLine.
          </li>
          <li>
            You may terminate this Agreement by terminating your account or
            deleting the App and all copies thereof from your Mobile Device.
          </li>
          <li>
            FlyLine may terminate this Agreement at any time without notice for
            any reason in its sole discretion. In addition, this Agreement will
          ...
          <li>
            ...
            will also terminate; and you must cease all use of the App and
            delete all copies of the App from your Mobile Device and account.
          </li>
          <li>
            Termination will not limit any of FlyLine’s rights or remedies at
            law or in equity.
          </li>
        </ul>
        <p>
          12. <strong>Disclaimer of Warranties.</strong> THE APP IS PROVIDED TO
          ...
          FLYLINE, ON ITS OWN BEHALF AND ON BEHALF OF ITS AFFILIATES AND ITS AND
          ...
          WITH RESPECT TO THE APP, INCLUDING ALL IMPLIED WARRANTIES OF
          MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, AND
          NON-INFRINGEMENT, AND WARRANTIES THAT MAY ARISE OUT OF COURSE OF
          DEALING, COURSE OF PERFORMANCE, USAGE, OR TRADE PRACTICE. WITHOUT
          LIMITATION TO THE FOREGOING, FLYLINE PROVIDES NO WARRANTY OR
        ...
        <p>
          13. <strong>Limitation of Liability.</strong> TO THE FULLEST EXTENT
          PERMITTED BY APPLICABLE LAW, IN NO EVENT WILL FLYLINE OR ITS
          ...
          OR INABILITY TO USE THE APP OR THE CONTENT AND SERVICES FOR:
        </p>
        <ul>
          <li>
          ...
          <li>
            ...
            ACTUALLY PAID BY YOU FOR THE APP.
          </li>
        </ul>
        <p>
          ...
          REGARDLESS OF WHETHER SUCH DAMAGES WERE FORESEEABLE OR FLYLINE WAS
        ...
        <p>
          14. <strong>Indemnification.</strong> You agree to indemnify, defend,
          and hold harmless FlyLine and its officers, directors, employees,
          ...
          arising from or relating to your use or misuse of the App or your
          breach of this Agreement, including but not limited to the content you
          submit or make available through this App.
        </p>
        <p>15. <strong>Dispute Resolution and Binding Arbitration.</strong></p>
        <strong>Informal Resolution</strong>
        <p>
          It our goal that the App meets your expectations and we live up to our
          promises to you. However, there may be instances when you feel that we
          have not fulfilled its obligations or you may have a different type of
          problem or dispute that needs special attention. In those instances,
          we are committed to working with you to reach a reasonable resolution
          that satisfies you; however, we can only do this if we know about and
          understand your issue. Therefore, for any problem or dispute that you
          may have with us, you acknowledge and agree that you will first give
          FlyLine an opportunity to resolve your problem or dispute. In order to
          initiate this dispute resolution process, you must first send us a
          written description of your problem or dispute within thirty (30) days
          of the event causing the dispute by sending us an email to
          <a href="mailto:support@joinFlyLine.com">support@joinFlyLine.com</a>.
        </p>
        <p>
          You then agree to negotiate with FlyLine in good faith about your
          ...
          sixty (60) days after FlyLine’s receipt of your written description of
          it, you agree to the further arbitration provisions below.
        </p>
        <p><strong>BINDING ARBITRATION</strong></p>
        <p>
          Arbitration Proceeding. Any dispute, claim or controversy arising out
          ...
          arbitrate, shall be determined by arbitration in Dallas, Texas before
          three arbitrators. The arbitration shall be administered by JAMS
          ...
          the Award may be entered in any court having jurisdiction. ANY
          ARBITRATION UNDER THIS AGREEMENT SHALL TAKE PLACE ON AN INDIVIDUAL
          BASIS. CLASS ACTION AND CLASS ARBITRATIONS ARE NOT PERMITTED. YOU
          UNDERSTAND THAT BY AGREEING TO THIS AGREEMENT, YOU WAIVE YOUR RIGHT TO
          PARTICIPATE IN CLASS ACTIONS. This clause shall not preclude parties
          from seeking provisional remedies in aid of arbitration from a court
          of appropriate jurisdiction.
        </p>
        <p>
          Exceptions to Arbitration. You and FlyLine agree that the following
          ...
          or concerning the validity of, any of FlyLine’s intellectual property
          rights; (b) any claim related to, or arising from, allegations of
          ...
          may assert an individual action in small claims court for claims that
          are within the scope of such court’s jurisdiction in lieu of
          arbitration.
        </p>
        <p>
          ...
          address listed below. The notice must be sent within 30 days of your
          first use of the Service, otherwise you shall be bound to arbitrate
          disputes in accordance with the terms of those paragraphs. If you
          opt-out of these arbitration provisions, FlyLine also will not be
          bound by them.
        </p>
        <p>
          16. <strong>Severability.</strong> If any provision of this Agreement
        ...
        <p>
          17. <strong>Governing Law.</strong> This Agreement is governed by and
          construed in accordance with the internal laws of the State of Texas
          without giving effect to any choice or conflict of law provision or
          rule. Any legal suit, action, or proceeding arising out of or related
          to this Agreement or the App shall be instituted exclusively in the
          federal courts of the United States or the courts of the State of
          Texas in each case located in Dallas, Texas. You waive any and all
          objections to the exercise of jurisdiction over you by such courts and
          to venue in such courts.
        </p>
        <p>
          18. <strong>Limitation of Time to File Claims.</strong> ANY CAUSE OF
          ACTION OR CLAIM YOU MAY HAVE ARISING OUT OF OR RELATING TO THIS
          AGREEMENT OR THE APP MUST BE COMMENCED WITHIN ONE (1) YEAR AFTER THE
          CAUSE OF ACTION ACCRUES OTHERWISE SUCH CAUSE OF ACTION OR CLAIM IS
          PERMANENTLY BARRED.
        </p>
        <p>
          19. <strong>Entire Agreement.</strong> This Agreement, our Privacy
          Policy, and any other terms referenced herein, constitute the entire
          agreement between you and FlyLine with respect to the App and
          supersede all prior or contemporaneous understandings and agreements,
          whether written or oral, with respect to the App.
        </p>
        <p>
          20. <strong>Waiver.</strong> No failure to exercise, and no delay in
