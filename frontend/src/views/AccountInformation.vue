<template>
  <div class="account-information">
    ...
    <tabs>
      ...
      <tab :selected="true" title="Traveler Information">
        <div class="main-padding">
          <div class="account__form">
            <div class="row">
              <div v-if="userReady" class="col-12 col-xl-10">
                <form action="">
                  <div class="row">
      ...
      <!-- Frequent Flyer Information Tab -->
      <tab title="Frequent Flyer Information">
        <div class="main-padding">
          <div class="account__form">
            <div class="row">
