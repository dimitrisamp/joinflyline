...
class AccountViewSet(RetrieveModelMixin, UpdateModelMixin, GenericViewSet):
    ...
    def get_object(self):
        accounts_models.Account.objects.get_or_create(user=self.request.user)
...
class FrequentFlyerViewSet(RetrieveModelMixin, UpdateModelMixin, GenericViewSet):
    ...
    def get_object(self):
        accounts_models.FrequentFlyer.objects.get_or_create(user=self.request.user)
...
class ProfileViewSet(RetrieveModelMixin, UpdateModelMixin, GenericViewSet):
    ...
    def get_object(self):
        accounts_models.Profile.objects.get_or_create(user=self.request.user)
